  ...
  return (
    <div className="w-full h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-6 right-6 z-10 pointer-events-auto flex items-center gap-2">
        <Link href="?present=0" className="text-sm text-[#A3A3A3] hover:text-[#EFEFEF] transition-all bg-transparent px-3 py-2 rounded-md opacity-60 hover:opacity-100 flex items-center gap-1.5">
